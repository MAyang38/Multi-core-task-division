...
vector<int> process1, process2,process3;

//int prio[10] = {-1 , 3, 8, 5, 2, 8, 4, 10, 1};
int prio[task_num + 1] = {-1};
int task_excute_time[task_num + 1] = {0, 1, 2, 1, 4, 1, 3, 1, 1, 1, 2, 2};
...
int choose_task()
{
    ...
    {   
       // cout<<endl<<"check   "<<tasks[i].id<<endl;
